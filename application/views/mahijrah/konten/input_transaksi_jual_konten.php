        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Transaksi Jual</h3>
            </div>
            ...
            <form role="form" method="POST" action="<?php echo base_url(); ?>index.php/mahijrah/simpaninput_transaksi">
              ...
              <input type="text" name="jual" value="Jual" readonly hidden>
                <table class="table table-bordered">
                
                <?php foreach ($jual as $sell) {
                      ?>
                      <input type="text" name="id_jual" value="<?php echo $sell->id_jual;?>" readonly hidden>
                 <tr>
                  <td>Tanggal Jual</td>
                  <td><input type="date" class="form-control" name="tgl_jual"></td>
                </tr>
              <?php }?>
                <tr>
                  <td>Nama Pembeli</td>
              ...
              <a href="" data-toggle="modal" data-target="#ccl" title="Batal" class="btn btn-default">Batal</a> 
              </div>
